package com.pyckup.app.Helper;

public class URLHelper {
    public static final String base = "http://delivery.appoets.co/";
//    public static final String base = "https://dev.tranxit.co/";
    ...
    public static final String REDIRECT_EMAIL = "contact@tranxit.com" ;
    public static final String EMAIL_SUBJECT = "PYCKUP - HELP";
